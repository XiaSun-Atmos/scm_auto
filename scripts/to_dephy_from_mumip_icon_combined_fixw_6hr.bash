#!/bin/bash -u
# authors: Kathryn Newman, National Center for Atmospheric Research (knewman@ucar.edu);
#          Xia Sun, CIRES at CU Boulder/NOAA Global Systems Laboratory (Xia.Sun@colorado.edu)
# Fixed the forc_w/vertical advection issue, Xia Sun (2025-6-18)
...
ncatted -h -a surface_type,global,c,c,ocean -a surface_forcing_temp,global,o,c,surface_flux -a surface_forcing_wind,global,o,c,z0 \
-a surface_forcing_moisture,global,o,c,surface_flux -a nudging_ta,global,m,i,0 \
${filename} -O ${filename}
echo "surfaceForcing"
...
ncrename -h -a global@startDate,start_date -a global@endDate,end_date  -a global@adv_u,adv_ua \
-a global@adv_v,adv_va -a global@nudging_temp,nudging_ta -a global@forc_w,forc_wa \
-a global@forc_omega,forc_wap -a global@rad_temp,rad_rad_ta -a global@nudging_v,nudging_va \
-a global@nudging_u,nudging_ua ${filename} -O ${filename}
...
-a nudging_va,global,m,i,0 -a nudging_ua,global,m,i,0 -a nudging_rt,global,m,i,0 -a nudging_rv,global,m,i,0 \
-a nudging_qt,global,m,i,0 -a nudging_qv,global,m,i,0 -a nudging_theta,global,m,i,0 -a nudging_thetal,global,m,i,0 \
-a nudging_ta,global,m,i,0 -a forc_wa,global,m,i,1 -a forc_geo,global,m,i,1 \
${filename} -O ${filename} 

ncap2 -h -s 'time(:)={0,10800,21600}' ${filename} -O ${filename} 
...
-v u_adv,tnua_adv -v v_adv,tnva_adv -v u_nudging,ua_nudging -h -v v_nudging,va_nudging -v w,wa -v zorog,orog -v height,zh \
